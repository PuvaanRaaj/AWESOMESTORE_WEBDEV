        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $supplier['supplier_age'];?></td>
              <td><?php echo $supplier['supplier_email'];?></td>
              <td><?php echo $supplier['supplier_address'];?></td>
              <td><?php echo $supplier['supplier_shop'];?></td>
              
              <td><a class="btn btn-primary" href="edit_supplier.php?supplier_id=<?php echo $supplier['supplier_id'];?>">Edit</a></td>
              <td><a class="btn btn-danger"  href="delete_supplier.php?supplier_id=<?php echo $supplier['supplier_id'];?>">Delete</a></td>

      ...
      <div class="container-fluid">
       ...
       <nav class="navbar navbar-expand-lg fixed-top bg-dark">  
         ...
         <div class="nav-content collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav  ms-auto" style="margin:0 70px 0 0; ">
             <li class="nav-item">
             ...
             <li class="nav-item d-xl-inline-block ms-1 mx-5" style="margin:0 20px 0 0; ">
               <div class="dropdown">
                  ...
                  <a class="item">
                    <i class="fa-solid fa-user"></i>
                      <?php echo htmlspecialchars($_SESSION["staff_name"]); ?></a>
                  </button>

    ...
    <div class="row">
           <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                   <h3 class="mb-sm-0 mt-5 pt-5">Products</h3>
                   <div class="page-title-right menu">
                       <ol class="breadcrumb mt-5 pt-5">
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Last Modifed Date</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-danger"  href="delete_products.php?product_id=<?php echo $product['product_id'];?>" >Delete</a></td>
